...
[bcl2fastq](https://support.illumina.com/sequencing/sequencing_software/bcl2fastq-analysis-software/bcl2fastq-conversion-software-v2-20.html) converts BCL files generated by Illumina sequencing systems to standard FASTQ file formats and demultiplexes data.
...
- `<flowcell_id>/L00<meta.lane>/Stats/`
  - `AdapterTrimming.txt`: Adapter trimming statistics
  - `ConversionStats.xml`: Conversion statistics
  - `DemultiplexingStats.xml`: Demultiplexing statistics
  - `DemuxSummaryF1L1.txt`: Demultiplex summary
  - `FastqSummaryF1L1.txt`: FASTQ summary
  - `Stats.json`: Statistics in JSON format

- `<flowcell_id>/L00<meta.lane>/Reports/`
  - HTML reports for the demultiplexing run
