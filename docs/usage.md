...
```bash
nextflow run nf-core/demultiplex --input '*_R{1,2}.fastq.gz' -profile docker
```
...
* `docker`
  ...
  * Pulls software from Docker Hub: [`nfcore/demultiplex`](https://hub.docker.com/r/nfcore/demultiplex/)
* `singularity`
